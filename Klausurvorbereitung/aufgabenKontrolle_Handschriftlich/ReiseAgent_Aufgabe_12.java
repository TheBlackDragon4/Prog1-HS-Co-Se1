...
public class ReiseAgent_Aufgabe_12 {
	...
	public Reise_Aufgabe_12 buchen(String ziel, String beginn) { // .equals -> Inhalt / Wert wird überprüft
		...
		for (Reise_Aufgabe_12 reise : reise) { // Verkürzte For - Schleife -> Nur für das Lesen verwendbar
			if (reise.getZiel().equals(ziel) && reise.getBeginn().equals(beginn) && reise.istGebucht() == false) {
				reise.setGebucht(true);
			}
			return reise;
		}
		return null;
